package com.iindicar.indicar.view.carSearch;
...
import com.iindicar.indicar.databinding.ActivityCarFilterBinding;
import com.iindicar.indicar.model.ListViewItem;
...
public class CarSearchActivity extends BaseActivity<ActivityCarFilterBinding> {
...
//        dialog.show();
        ...
        firstAdapter = new CarListAdapter();
        ...
        binding.searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable edit) {
                ...
                ((CarListAdapter) binding.listView.getAdapter()).getFilter().filter(filterText);
