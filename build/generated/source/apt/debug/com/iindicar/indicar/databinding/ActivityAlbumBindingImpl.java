...
public class ActivityAlbumBindingImpl extends ActivityAlbumBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_total_count, 2);
        sViewsWithIds.put(R.id.recycler_album, 3);
    ...
    public ActivityAlbumBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityAlbumBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
