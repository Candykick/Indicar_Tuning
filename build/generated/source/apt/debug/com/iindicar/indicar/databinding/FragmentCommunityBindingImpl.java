...
public class FragmentCommunityBindingImpl extends FragmentCommunityBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tab_layout_community, 3);
        sViewsWithIds.put(R.id.view_pager_board, 4);
        sViewsWithIds.put(R.id.fab_write, 5);
    }
    // views
    @NonNull
    ...
    public FragmentCommunityBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FragmentCommunityBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (android.support.v4.view.ViewPager) bindings[4]
            );
