...
public class FragmentMainBindingImpl extends FragmentMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.image_tuning, 3);
        sViewsWithIds.put(R.id.recycler_notice, 4);
    }
    // views
    @NonNull
    ...
    public FragmentMainBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentMainBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
