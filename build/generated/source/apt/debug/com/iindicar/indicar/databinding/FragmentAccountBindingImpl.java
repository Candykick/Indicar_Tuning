...
public class FragmentAccountBindingImpl extends FragmentAccountBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tab_layout_account, 3);
        sViewsWithIds.put(R.id.view_pager_account, 4);
    }
    // views
    @NonNull
    ...
    public FragmentAccountBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentAccountBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
