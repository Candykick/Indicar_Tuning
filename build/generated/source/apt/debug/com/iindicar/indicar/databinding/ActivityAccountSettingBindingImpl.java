...
public class ActivityAccountSettingBindingImpl extends ActivityAccountSettingBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.recycler_account, 3);
    ...
    public ActivityAccountSettingBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityAccountSettingBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.activity == variableId) {
            setActivity((com.iindicar.indicar.view.account.profile.AccountSettingActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.iindicar.indicar.view.account.profile.AccountSettingActivity Activity) {
